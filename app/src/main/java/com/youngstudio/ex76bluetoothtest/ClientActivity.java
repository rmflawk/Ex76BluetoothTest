package com.youngstudio.ex76bluetoothtest;
...
public class ClientActivity extends AppCompatActivity {
    ...
    public static final int REQ_DISCORVERY=20;
    ...
    class ClientThread extends Thread{
        ...
        String address; // 연결할 장치의 주소

        public ClientThread(@NonNull String address) {
            this.address= address;
        }

        @Override
        public void run() {
            //소켓생성하기 위해 Bluetooth 장치객체 얻어오기
