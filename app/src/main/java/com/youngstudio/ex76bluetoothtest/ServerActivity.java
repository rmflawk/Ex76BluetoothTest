...
public class ServerActivity extends AppCompatActivity {
    ...
    class ServerThread extends Thread{
        ...
        public void run() {
            //서버소켓 생성
            try {
                serverSocket= bluetoothAdapter.listenUsingInsecureRfcommWithServiceRecord("SERVER", BT_UUID);//장치의 고유번호
                showText(" 서버소켓 생성했습니다.\n클라이언트의 접속을 기다립니다.\n");
